...
import com.threetenterprises.mylibrary.mylibraryapp.application.composition.ApplicationModule;
import com.threetenterprises.mylibrary.mylibraryapp.application.composition.DaggerApplicationComponent;
...
@Override
    public void onCreate() {
        ...
        // build the main component, supplying the application context
        // object for injection into other areas of the application
        //
        DaggerApplicationComponent.builder()
                                  .applicationModule(new ApplicationModule(MyLibraryApplication.this))
                                  .build()
                                  .inject(this);
    }
